...
<div id="right_col" style="font-size:10px;width:770px ">
	...
	<tr>
		<td width="120">Jenis Kerusakan</td> <td>:</td>
		<td> <strong><?php echo strtoupper($nama_pilihan);?></strong></td>
	</tr>
	<tr>
		<td>kriteria-kriteria</td><td>:</td>
	...
	<table width="100%" class="tabel_t4" cellpadding="0" cellspacing="0" border="0" align="center">
	<thead>
	<tr>
		<th class="t4_title" align="center" width="30">NO</th>
		<th class="t4_title" align="center" width="100">KODE</th>
		<th class="t4_title" align="center">JENIS KERUSAKAN</th>
